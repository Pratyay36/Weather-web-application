...
let temp=document.getElementById("temp-icon");
...
const getWeather=async(city)=>{
    try{
        ...
        constweatherData=await response.json();
...
if(navigator.geolocation){
    ...
    const api=`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=30ae6516d8f8007ed46fa4abfcb922ad`
